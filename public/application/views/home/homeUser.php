    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/Logout" data-toggle="modal" data-target="#logoutModal">
        ...
        <div class="embed-responsive embed-responsive-16by9">
          <iframe src="http://10.199.66.227/SoftEn2020/Sec01/Jotaro%20Inc/iFrame.php"></iframe>
        </div>
        ...
        <!-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="https://www.cs.kku.ac.th/images/news/2562/06bff-untitled-1.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.cs.kku.ac.th/images/Web/slide/banner-web.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="https://www.cs.kku.ac.th/images/Web/slide/banner web jpg.jpg" alt="Third slide">
            </div>
          </div>
