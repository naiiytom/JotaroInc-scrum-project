      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url(); ?>">Buttons</a>
            <a class="collapse-item" href="<?php echo base_url(); ?>">Cards</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url(); ?>">404 Page</a>
            <a class="collapse-item active" href="<?php echo base_url(); ?>">Blank Page</a>
          </div>
        </div>
      </li>
